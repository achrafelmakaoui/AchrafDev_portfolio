        ...
        <div className='container'>
            <div className='hero-main'>
                <div className='hero-text'>
                    ...
                    <img className='Waving' src={Waving} alt='Waving'/>
                    <p>Hi, I'm Achraf EL MAKAOUI. A passionate Full Stack Developer based in Laâyoune, Maroc. 📍</p>
                    <span>
            ...
            <div class="skills">
                ...
                <div class="logos">
                    <ul>
                        ...
                        <li>
                            <img src="https://skillicons.dev/icons?i=react,nodejs" alt="skill-icon"/>
                        </li>
                        <li>
                            <img src="https://skillicons.dev/icons?i=express,mongodb" alt="skill-icon"/>
                        </li>
                    </ul>
                </div>
            </div>
