...
const ProjectInfo = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Achraf El Makaoui | {project.title}</title>
                <meta name="description" content={project.description} />
                <link rel="canonical" href={`https://www.achrafelmakaoui.com/projects/${category}/${slug}`} />
            </Helmet>
            <div className='ProjectInfo'>
                <div className='projectInfoContainer'>
                    <div className="ProjectInfo-Header">
                        <div className='Header-Content'>
                            {theme==='light' && <><Link to="/"><img src={AdbLogo} alt="Achraf El Makaoui Logo" title="Achraf El Makaoui Logo"/></Link></>}
                            {theme==='dark' && <><Link to="/"><img src={AdbWLogo} alt="Achraf El Makaoui Logo" title="Achraf El Makaoui Logo"/></Link></>}
                            <h1>{project.title}</h1>
                        ...
                        <div className='Header-Divider'>
                            ...
                            <div className='Creator-Img'>
                                <img src={Owner} alt='Achraf El Makaoui, Full Stack Developer' title='Achraf El Makaoui, Full Stack Developer'/>
                            </div>
                        </div>
                    </div>
                    <div className='ProjectInfo-Details'>
                        ...
                        <div className="ProjectInfo-images">
                            <div className='ProjectInfo-MainImage'>
                                <img src={mainImage} alt={`Achraf El Makaoui, ${project.title}`} title={`${project.title}, UI`}/>
                            </div>
                            <div className="ProductDetails-SecondaryImages">
                                {secondaryImages.map((image, index) => (
                                    <img key={index} src={image} alt={`Achraf El Makaoui, ${project.title}`} title={`${project.title}, UI`} className={activeImage === image ? "active" : ""} onClick={() => handleImageClick(image)}/>
                                ))}
                            </div>
                        </div>
