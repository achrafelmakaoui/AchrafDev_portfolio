    ...
    <>
      <nav>
          ...
          <div className='darkmode_toggele'>
            {theme==='light' && 
            <>
              <svg height="22" viewBox="0 0 1792 1792" width="22" fill='#2d2e32' onClick={handelMoonClick} id='darkmode-toggle'>
            ...
            {theme==='dark' && 
            <>
              <svg id='darkmode-toggle' stroke="#f5f5f5" fill="none"  height="22" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="22" onClick={handelSunClick}>
