...
import Owner from '../../images/heroIMG.jpg'
          ...
          <div className='projectInfoContainer'>
              <div className="ProjectInfo-Header">
                  <div className='Header-Content'>
                      {theme==='light' &&
                          <>
                              <Link to="/"><img src={AdbLogo} alt="logo dark"/></Link>
                          </>
                      }
                      {theme==='dark' &&
                          <>
                            <Link to="/"><img src={AdbWLogo} alt="logo white"/></Link>
                          </>
                      }
                      <h1>{project.title}</h1>
              ...
              <div className='projectInfo-Footer'>
                  <div className='projectInfo-GoBack'>
                      <Link to="/">
                          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
                          <span>Go back</span>
                      </Link>
                  </div>
                  <div className='projectInfo-Social'>
                      ...
                      <a href='mailto:elmakaouiachraf@gmail.com' target="_blank" aria-label="Send me an email on Gmail" rel="noopener noreferrer"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg></a>
                  </div>
              </div>
          </div>
      </div>
